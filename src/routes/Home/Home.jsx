...
export default function Home() {
  return (
    <BaseLayout>
      ...
      <div className="w-full h-fit py-24 px-4 md:py-32 md:px-8 xl:px-16 grid grid-cols-4 md:grid-cols-12 gap-4 bg-mib-beige-dark">
        <IndexPoint colorClass="mib-brown-dark" className="col-span-4 md:col-span-3">
          Introduzione
        </IndexPoint>
        <Quote
      ...
      <div className="w-full h-fit px-4 md:py-32 md:px-8 xl:px-16 grid grid-cols-4 md:grid-cols-12 gap-4 bg-mib-beige-light">
      ...
      <div className="w-full h-fit py-24 px-4 md:py-32 md:px-8 xl:px-16 grid grid-cols-4 md:grid-cols-12 gap-4 bg-mib-beige-light">
        <IndexPoint colorClass="mib-brown-dark" className="col-span-4 md:col-span-3">
        ...
        />
        <ImageRect className="col-span-4 md:col-span-10 my-16"
        ...
        />
        <ImageRect className="col-span-4 md:col-start-2 md:col-span-10"
          imageUrl="assets/images/fullsize/10.jpg"
          dida="TEST DIDA"
        />
      </div>
      <div className="w-full h-fit px-4 md:py-32 md:px-8 xl:px-16 grid grid-cols-4 md:grid-cols-12 gap-4 bg-mib-brown-dark">
        <Heading text="Territorialità" colorClass="text-mib-beige-light" />
        <IndexPoint className="col-span-4 md:col-span-3" colorClass="mib-beige-light">
        ...
        />
        <ImageRect className="col-span-4 md:col-span-3 md:my-16"
        ...
        />
        <ImageRect className="col-span-4 md:col-start-2 md:col-span-6 md:my-16"
          imageUrl="assets/images/fullsize/10_1.jpg"
          dida="TEST DIDA"
        />
        <ImageRect className="col-span-4 md:col-start-9 md:col-span-3 md:my-16"
