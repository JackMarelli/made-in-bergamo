...
export default function AlbiniGroup() {
  return (
    <InterviewLayout>
      ...
      <BrandSheet>
        <BrandSheetRow title="Anno di fondazione">1876</BrandSheetRow>
        <BrandSheetRow title="Fondatore">Zaffiro Borgomanero</BrandSheetRow>
        <BrandSheetRow title="Presidente attuale">Stefano Albini</BrandSheetRow>
        ...
        <BrandSheetRow title="Valori">
          ...
          Sostenibilità
          <br /> Innovazione
          <br /> Etica e valorizzazione dei dipendenti
        </BrandSheetRow>
        <BrandSheetRow title="Dipendenti">
          Oltre 1000 nelle diverse sedi (in Italia e all'estero)
        </BrandSheetRow>
      ...
      <InterviewQuestion question="Quando è nato Albini Group, come lavora e quali sono i suoi valori?">
        ...
        rappresentata da Fabio, Andrea e Stefano Albini. Questo aspetto è sempre
        stato fondamentale e pensiamo che la presenza attiva della famiglia stia
        alla base di un’ampia visione del successo d’impresa e che garantisca un
        orientamento al lungo periodo, un forte attaccamento al prodotto e un
        impegno etico condiviso. La nostra proposta si articola su diversi
        marchi, ognuno con una propria identità legata alla profonda storia di
        ogni singolo brand. Albini nato nel 1876, Thomas Mason fondato nel 1796
        e Albiate nel 1830, costituiscono i pilastri delle collezioni di tessuti
        che si rivolgono a consumatori con gusti definiti ed esigenze
        differenti. Un altro valore della nostra azienda è il suo legame con il
        territorio, fin dal 1876 il Gruppo è presente nella Bergamasca dove
        intere generazioni hanno lavorato nei suoi stabilimenti, contribuendo a
        tramandare il know-how e la passione che rendono Albini Group
        un’eccellenza nel mondo. Il nostro lavoro e le collezioni che proponiamo
        al mercato sono il risultato di un processo di ricerca e sviluppo
        attento all’innovazione: lungo la filiera ogni singola fase della
        creazione di un tessuto diventa un’opportunità per innovare. Ad oggi
        contiamo più di 1000 dipendenti nel mondo, con una coesistenza di 27
        nazionalità diverse, sparsi nelle nostre sedi in giro per il mondo, come
        negli USA e ad Hong Kong».
      </InterviewQuestion>
      ...
      <InterviewQuestion question="Quali tessuti create e in che quantità?">
        ...
        team stilistici, composti da più di trenta persone. Le nostre collezioni
        nascono a seguito di una costante ricerca di materie prime pregiate e di
        un’analisi dei trend internazionali, mantenendo sempre lo stile e la
        tradizione dei nostri brand. Puntiamo ad offrire ai nostri clienti
        collezioni che spaziano dal gusto più sportivo o contemporaneo fino al
        più classico e sartoriale. Proponiamo i nostri “tessuti armaturati”, i
        quali danno un effetto di tridimensionalità e donano movimento al
        tessuto; I “tessuti doppi ritorti”, caratterizzati da una straordinaria
        resistenza e brillantezza; I “popeline”, molto morbidi e raffinati; I
        tessuti “stretch”, dotati di elevata compattezza e luminosità; Le stampe
        realizzate con tecniche all’avanguardia; I voile e le mussole, tessuti
      ...
      <InterviewQuestion question="Prestate attenzione all’aspetto della sostenibilità? Quali tecniche avete adottato?">
        ...
        dell’ambiente e delle persone. Dal 2017 siamo diventati membri di Better
        Cotton Initiative, un’organizzazione no-profit che mira a rendere la
        produzione globale di cotone progressivamente migliore per le persone
        che la producono, per l’ambiente e per il futuro del settore. Prestiamo
      ...
      <InterviewQuestion question="Vi ritenete un’azienda che opera in modo etico?">
        ...
        promuovono la persona e le sue capacità e garantiscono il rispetto delle
        leggi, dei contratti e dei regolamenti vigenti, con particolare
        ...
        benessere dei dipendenti. La nostra visione aziendale riflette un forte
        interesse per le pari opportunità, la multiculturalità e la famiglia.
        Per noi il riconoscimento e lo sviluppo delle capacità individuali delle
        risorse interne sono aspetti di primaria importanza. Inoltre, in
        collaborazione con le università e gli istituti tecnici di riferimento,
        viene privilegiato l’inserimento di giovani tramite l’avvio di stage e
        recruiting finalizzati all’assunzione. Inoltre investiamo molto per
      ...
      <InterviewQuestion question="Dove vendete i vostri tessuti?">
        ...
        che vendiamo i nostri tessuti principalmente ad altre aziende
        tessili/fashion, le quali li utilizzano per confezionare capi che
        compongono le loro collezioni. Durante le fiere (ma non solo, anche
        durante tutto l’anno) le aziende possono acquistare i metri di tessuto
        ...
        poi farlo confezionare al sarto di fiducia. Possono trovare anche
        un’ampia scelta di capi già confezionati per uomo e donna».
      </InterviewQuestion>
      <InterviewQuestion question="Come gestite la parte relativa alla comunicazione e quali canali utilizzate?">
        «Per riuscire a mantenere la nostra posizione di leadership sul mercato
        è necessaria una sinergia e coerenza fra la qualità del prodotto, del
        servizio e della comunicazione a supporto. Essa è gestita secondo un
        approccio inter-funzionale che ha dato risultati ancora più solidi e
        credibili nei confronti dei nostri clienti e di tutti gli stakeholder.
        Siamo attivi su tutti i social media, tutti i nostri brand sono su
        Instagram, mentre su LinkedIn abbiamo un profilo in cui comunichiamo
        attività corporate. Inoltre, ogni brand ha il proprio sito web, nel
        quale raccontiamo le collezioni, le iniziative e le collaborazioni.
        Inoltre teniamo anche alla comunicazione interna e per questo è stata
        lanciata la nuova intranet aziendale, “Albini Square”, una vera e
        propria piazza virtuale del Gruppo per la gestione delle news, la
        pubblicazione di documenti utili nel lavoro quotidiano e la
        digitalizzazione di alcuni processi interni».
      </InterviewQuestion>
    </InterviewLayout>
  );
}
